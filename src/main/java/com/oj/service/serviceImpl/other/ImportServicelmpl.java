...
import com.oj.service.serviceImpl.student.StudentServiceImpl;
/*
...
public class ImportServicelmpl implements ImportService {
    ...
    public Student checkB(String account, String name, String classId,String college_id ) throws Exception{
        ...
        return new Student(account,  name, classId,college_id);
